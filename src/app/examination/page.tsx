    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4 text-teal-800">Iqbal's Team working hard on the Examination Page</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            We're working to improve your experience with a new and improved Examination page
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Our new examination page will be ready soon Insallah. It
          ...
          <h2 className="text-2xl font-bold mb-6 text-center text-teal-800">
            In the meantime, you can still get information about Examination:
          </h2>
