    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4 text-teal-800">Iqbal&#39;;;s Team working hard on the Result Page</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            We're working to improve your experience with a new and improved Result page
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Our new Result page will be ready soon Insallah. It
          ...
          <h2 className="text-2xl font-bold mb-6 text-center text-teal-800">
            In the meantime, you can still get information about Result:
          </h2>
          ...
          {/* <div className="bg-white p-6 rounded-lg shadow-sm border mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold">Entrance Result</h3>
