      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-6 bg-white rounded-2xl shadow-md p-6">
          ...
          <p className="text-gray-700 text-lg">
            Name: <span className="font-medium">{session?.user?.fullName || "Teacher"}</span>
          </p>
          <p className="text-gray-700 text-lg">
            Class Teacher: <span className="font-medium">{session?.user?.assignedClass || "Class Teacher"}</span>
          </p>
          <p className="text-gray-700 text-lg">
            Section: <span className="font-medium">{session?.user?.section || "Class Section"}</span>
          </p>
          <p className="text-gray-700 text-lg">
            Subject: <span className="font-medium">{session?.user?.subject || "Student Roll Number"}</span>
          </p>
        </section>
